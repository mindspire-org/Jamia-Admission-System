        ...
        <div class="receipt-wrapper">
          <div class="receipt">
            ...
            <div class="details">
              ...
              <div class="detail-row">
                <span class="detail-label">جماعت:</span>
      ...
      <Card className="mb-6">
        ...
        <CardContent>
          <Input
            ...
            placeholder="ٹوکن نمبر، نام یا جماعت سے تلاش کریں"
            className="h-12"
          />
        </CardContent>
      </Card>
              ...
              <div className="border-2 border-black p-5 text-center mx-auto max-w-[320px] bg-white">
                ...
                <table className="w-full text-right text-sm" dir="rtl">
                  <tbody>
                    ...
                    <tr className="border-b border-dotted border-gray-300">
                      <td className="py-2 text-emerald-700 font-semibold">جماعت:</td>
          ...
          {viewing && (
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1">
                  <Label className="text-muted-foreground text-xs">جماعت</Label>
